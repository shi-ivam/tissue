...
const tracks = [
  {title: 'Another New World', path: 'http://localhost:5000/defaultMusic/AlanWalker-Fade[NCSRelease].mp3'},
  {title: '715 - CRΣΣKS', path: 'http://localhost:5000/defaultMusic/AlanWalker-Fade[NCSRelease].mp3'},
  {title: 'The Wilder Sun', path: 'http://localhost:5000/defaultMusic/AlanWalker-Fade[NCSRelease].mp3'},
  {title: 'Lost It To Trying', path: 'http://localhost:5000/defaultMusic/AlanWalker-Fade[NCSRelease].mp3'},
  {title: 'Adagio for Strings', path: 'http://localhost:5000/defaultMusic/AlanWalker-Fade[NCSRelease].mp3'}
